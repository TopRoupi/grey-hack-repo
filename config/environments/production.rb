...
Rails.application.configure do
  ...
  # config.asset_host = "https://www.greyrepo.xyz"
  ...
  # config.active_job.queue_name_prefix = "grey_repo_production"
  config.active_job.queue_name_prefix = "greyrepo_#{Rails.env}"
